...
const CriarDieta = () =>{
    ...
    function adicionaAlimento() {
        ...
        console.log(typeof refeicaoSelecionada);
        
        if (!refeicaoSelecionada || isNaN(refeicaoSelecionada)) {
            console.error("Refeição selecionada não válida");
            return;
        }
        const index = parseInt(refeicaoSelecionada)
        console.log(typeof index);
        console.log(index);

        if (refeicaoSelecionada && alimento.nome && alimento.quantidade) {
            // setRefeicoesAdicionadas({
            //     ...refeicoesAdicionadas,
            //     refeicoesAdicionadas[index].alimento:{
            ...
            setDieta({
                ...dieta,
                refeicoes: refeicoesAdicionadas,
            });
            console.log(dieta)
                    ...
                    <div className='CriaDieta-planoAlimentar'>
                        ...
                        <div className='CriaDieta-inputRefeicao'>
                            ...
                            <div className='CriaDieta-areaAguaCha'>
                                ...
                                <button className="CriarDieta-adicionaBtn" onClick={adicionaAlimento}>Adicionar Alimento</button>
                            </div>
                        </div>
                        ...
                        <div className='CriarDieta-areaRefeicoes'>
                            {dieta.refeicoes ? dieta.refeicoes.map((refeicao, indexRefeicao) => (
                                <div key={indexRefeicao} className='CriarDieta-cardRefeicao'>
                                    ...
                                    {refeicao.alimento.nome ? refeicao.alimento.map((alimento, indexAlimento) => (
                                        <div className='CriarDieta-alimentosRefeicao' key={indexAlimento}>
                                            <p >{alimento.nome}</p>
                                            <p >{alimento.quantidade}</p>
                                            <p >{alimento.proteinas}</p>
                                            <p >{alimento.gorduras}</p>
                                            <p >{alimento.carboidratos}</p>
                                            <button className='CriarDieta-excluiItem' onClick={<></>}>x</button> 
                                        </div>
                                    )) : <></>}
